-- Script: year_wise_late_aircraft_delay.hql
...
-- Query to get year-wise late aircraft delay from 2003 to 2010
SELECT Year,  AVG((LateAircraftDelay/ ArrDelay) * 100) AS LateAircraftDelay
