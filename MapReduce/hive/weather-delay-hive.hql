-- Script: year_wise_weather_delay.hql
...
-- Query to get year-wise weather delay from 2003 to 2010
SELECT Year, AVG((WeatherDelay/ ArrDelay) * 100) AS TotalWeatherDelay
